    ...
    def _get_dummy_node(self, *args, **kwargs):
        ...
        class DummyNode(object):
            attrs = {
                ...
                'data-transition-speed': None,
                'data-background': None,
                'data-background-color': None,
                'data-background-image': None,
                'data-background-size': None,
                'data-background-position': None,
                'data-background-repeat': None,
                'data-background-video': None,
                'data-background-video-loop': None,
                'data-background-video-muted': None,
                'data-background-transition': None,
                'data-background-iframe': None,
                'data-background-interactive': None,
                'data-state': None,
                'data-markdown': None,
                'data-separator': None,
                'data-separator-vertical': None,
                'data-separator-notes': None,
                'data-charset': None,
            }
